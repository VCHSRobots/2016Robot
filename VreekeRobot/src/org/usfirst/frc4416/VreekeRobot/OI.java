...
public class OI {
    ...
    public JoystickButton driveFor1Second;
    ...
    public OI() {
        ...
        driveFor1Second = new JoystickButton(joystick1, 1);
        driveFor1Second.whenPressed(new DriveForward());
        ...
        SmartDashboard.putData("Ryan Drive", new RyanDrive());
